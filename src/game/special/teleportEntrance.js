...
var TeleportEntrance = Unit.extend({
    ...
    findTargetExit: function() {
        if (this.data && this.data.targetExit) {
            this.data.targetExit = -Math.abs(this.data.targetExit);
            // TODO: reference or something for worldHandler
    ...
    tick: function(dTime) {
        ...
        if (this.targetExit) {
            if (this.useTimeout > 0) {
                ...
                // TODO: reference or something for worldHandler OR will this.otherUnits work here?
